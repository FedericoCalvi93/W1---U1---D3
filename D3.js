...
*/
switch (eyeColor){
  case coloreocchi1[i]: coloreocchi1.push(starWarsCharacters[0]);break
  console.log("coloreocchi1", coloreocchi1)
  case coloreocchi2[i]: coloreocchi2.push(starWarsCharacters[1]);break
  console.log("coloreocchi2", coloreocchi2)
  case coloreocchi3[i]: coloreocchi3.push(starWarsCharacters[4]);break
  console.log("coloreocchi3", coloreocchi3)
  case coloreocchi4[i]: coloreocchi4.push(starWarsCharacters[7]);break
  console.log("coloreocchi4", coloreocchi4)
  case coloreocchi5[i]: coloreocchi1.push(starWarsCharacters[4]);break
  console.log("coloreocchi1", coloreocchi1)
  case coloreocchi1[i]: coloreocchi1.push(starWarsCharacters[9]);break
  console.log("coloreocchi1", coloreocchi1)}
/* ESERCIZIO 6
  Usa un while loop per calcolare la massa totale dell'equipaggio. Salvala in una variabile chiamata "crewMass".
*/
for (let i = 0; i < starWarsCharacters.length; i++){let
random=0}
